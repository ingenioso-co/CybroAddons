...
export class OrgChart extends Component {
    ...
    setup() {
        ...
        onWillStart(async () => {
            ...
            await this.DepartmentDetails(this.props.record.evalContextWithVirtualIds.active_id, model);
        });
        onWillUpdateProps(async (nextProps) => {
            const model = nextProps.record.resModel;
            await this.DepartmentDetails(nextProps.record.evalContextWithVirtualIds.active_id, model);
        });
